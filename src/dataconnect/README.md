...
## GetProductBySku
You can execute the `GetProductBySku` query using the following action shortcut function, or by calling `executeQuery()` after calling the following `QueryRef` function, both of which are defined in [dataconnect/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `GetProductBySkuData`, which is defined in [dataconnect/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
You can execute the `SearchProductsByName` query using the following action shortcut function, or by calling `executeQuery()` after calling the following `QueryRef` function, both of which are defined in [dataconnect/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `SearchProductsByNameData`, which is defined in [dataconnect/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
You can execute the `GetProductsByCategory` query using the following action shortcut function, or by calling `executeQuery()` after calling the following `QueryRef` function, both of which are defined in [dataconnect/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `GetProductsByCategoryData`, which is defined in [dataconnect/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
You can execute the `GetProductsByManufacturer` query using the following action shortcut function, or by calling `executeQuery()` after calling the following `QueryRef` function, both of which are defined in [dataconnect/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `GetProductsByManufacturerData`, which is defined in [dataconnect/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
## GetLowStockProducts
You can execute the `GetLowStockProducts` query using the following action shortcut function, or by calling `executeQuery()` after calling the following `QueryRef` function, both of which are defined in [dataconnect/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `GetLowStockProductsData`, which is defined in [dataconnect/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
## ListProductImages
You can execute the `ListProductImages` query using the following action shortcut function, or by calling `executeQuery()` after calling the following `QueryRef` function, both of which are defined in [dataconnect/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `ListProductImagesData`, which is defined in [dataconnect/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
You can execute the `GetProductImagesByProductId` query using the following action shortcut function, or by calling `executeQuery()` after calling the following `QueryRef` function, both of which are defined in [dataconnect/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `GetProductImagesByProductIdData`, which is defined in [dataconnect/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
## ListManufacturers
You can execute the `ListManufacturers` query using the following action shortcut function, or by calling `executeQuery()` after calling the following `QueryRef` function, both of which are defined in [dataconnect/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `ListManufacturersData`, which is defined in [dataconnect/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
## GetManufacturerById
You can execute the `GetManufacturerById` query using the following action shortcut function, or by calling `executeQuery()` after calling the following `QueryRef` function, both of which are defined in [dataconnect/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `GetManufacturerByIdData`, which is defined in [dataconnect/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
You can execute the `GetManufacturerByName` query using the following action shortcut function, or by calling `executeQuery()` after calling the following `QueryRef` function, both of which are defined in [dataconnect/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `GetManufacturerByNameData`, which is defined in [dataconnect/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
## GetCategoryById
You can execute the `GetCategoryById` query using the following action shortcut function, or by calling `executeQuery()` after calling the following `QueryRef` function, both of which are defined in [dataconnect/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `GetCategoryByIdData`, which is defined in [dataconnect/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
## GetCategoryByName
You can execute the `GetCategoryByName` query using the following action shortcut function, or by calling `executeQuery()` after calling the following `QueryRef` function, both of which are defined in [dataconnect/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `GetCategoryByNameData`, which is defined in [dataconnect/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
## GetChildCategories
You can execute the `GetChildCategories` query using the following action shortcut function, or by calling `executeQuery()` after calling the following `QueryRef` function, both of which are defined in [dataconnect/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `GetChildCategoriesData`, which is defined in [dataconnect/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
## GetParentCategory
You can execute the `GetParentCategory` query using the following action shortcut function, or by calling `executeQuery()` after calling the following `QueryRef` function, both of which are defined in [dataconnect/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `GetParentCategoryData`, which is defined in [dataconnect/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
## ListCPUs
You can execute the `ListCPUs` query using the following action shortcut function, or by calling `executeQuery()` after calling the following `QueryRef` function, both of which are defined in [dataconnect/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `ListCpUsData`, which is defined in [dataconnect/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
## ListGPUs
You can execute the `ListGPUs` query using the following action shortcut function, or by calling `executeQuery()` after calling the following `QueryRef` function, both of which are defined in [dataconnect/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `ListGpUsData`, which is defined in [dataconnect/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
## ListStorage
You can execute the `ListStorage` query using the following action shortcut function, or by calling `executeQuery()` after calling the following `QueryRef` function, both of which are defined in [dataconnect/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `ListStorageData`, which is defined in [dataconnect/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
## ListPSUs
You can execute the `ListPSUs` query using the following action shortcut function, or by calling `executeQuery()` after calling the following `QueryRef` function, both of which are defined in [dataconnect/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `ListPsUsData`, which is defined in [dataconnect/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
## ListCPUCoolers
You can execute the `ListCPUCoolers` query using the following action shortcut function, or by calling `executeQuery()` after calling the following `QueryRef` function, both of which are defined in [dataconnect/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `ListCpuCoolersData`, which is defined in [dataconnect/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
## ListCases
You can execute the `ListCases` query using the following action shortcut function, or by calling `executeQuery()` after calling the following `QueryRef` function, both of which are defined in [dataconnect/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `ListCasesData`, which is defined in [dataconnect/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
## ListRAM
You can execute the `ListRAM` query using the following action shortcut function, or by calling `executeQuery()` after calling the following `QueryRef` function, both of which are defined in [dataconnect/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `ListRamData`, which is defined in [dataconnect/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
## ListMotherboards
You can execute the `ListMotherboards` query using the following action shortcut function, or by calling `executeQuery()` after calling the following `QueryRef` function, both of which are defined in [dataconnect/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `ListMotherboardsData`, which is defined in [dataconnect/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
## CreateCPUSpecs
You can execute the `CreateCPUSpecs` mutation using the following action shortcut function, or by calling `executeMutation()` after calling the following `MutationRef` function, both of which are defined in [dataconnect/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `CreateCpuSpecsData`, which is defined in [dataconnect/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
## CreateGPUSpecs
You can execute the `CreateGPUSpecs` mutation using the following action shortcut function, or by calling `executeMutation()` after calling the following `MutationRef` function, both of which are defined in [dataconnect/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `CreateGpuSpecsData`, which is defined in [dataconnect/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
## CreateStorageSpecs
You can execute the `CreateStorageSpecs` mutation using the following action shortcut function, or by calling `executeMutation()` after calling the following `MutationRef` function, both of which are defined in [dataconnect/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `CreateStorageSpecsData`, which is defined in [dataconnect/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
## CreatePSUSpecs
You can execute the `CreatePSUSpecs` mutation using the following action shortcut function, or by calling `executeMutation()` after calling the following `MutationRef` function, both of which are defined in [dataconnect/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `CreatePsuSpecsData`, which is defined in [dataconnect/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
You can execute the `CreateCPUCoolerSpecs` mutation using the following action shortcut function, or by calling `executeMutation()` after calling the following `MutationRef` function, both of which are defined in [dataconnect/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `CreateCpuCoolerSpecsData`, which is defined in [dataconnect/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
## CreateCaseSpecs
You can execute the `CreateCaseSpecs` mutation using the following action shortcut function, or by calling `executeMutation()` after calling the following `MutationRef` function, both of which are defined in [dataconnect/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `CreateCaseSpecsData`, which is defined in [dataconnect/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
## CreateRAMSpecs
You can execute the `CreateRAMSpecs` mutation using the following action shortcut function, or by calling `executeMutation()` after calling the following `MutationRef` function, both of which are defined in [dataconnect/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `CreateRamSpecsData`, which is defined in [dataconnect/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
You can execute the `CreateMotherboardSpecs` mutation using the following action shortcut function, or by calling `executeMutation()` after calling the following `MutationRef` function, both of which are defined in [dataconnect/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `CreateMotherboardSpecsData`, which is defined in [dataconnect/index.d.ts](./index.d.ts). It has the following fields:
```typescript
